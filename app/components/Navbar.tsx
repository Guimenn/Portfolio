...
import { FaCode, FaHome, FaUser, FaFolderOpen, FaEnvelope, FaBars, FaTimes, FaChevronDown, FaStar } from 'react-icons/fa';
...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      style={{
        backgroundImage: 'url(/img/cima.svg)',
    ...
    >
      {/* Background decoration - mesma animação do footer */}
      <div
        ...
        <div className="flex items-center justify-between h-20 relative">
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
            >
              <span className="relative z-10 flex text-white items-center gap-2">
                Vamos Conversar!
